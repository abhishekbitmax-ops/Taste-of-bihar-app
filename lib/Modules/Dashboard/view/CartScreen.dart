...
import 'package:taste_of_bihar/Modules/Dashboard/view/ApplyCoupanscreen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final rawRestaurantName = restaurant?.name ?? "";
        final restaurantName =
            rawRestaurantName.toLowerCase().contains("swaad of grandma")
            ? "Taste of Bihar"
            : rawRestaurantName;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(() {
                        final isUpdating =
                            cartCtrl.updatingIndex.value == index;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Obx(() {
                        final isRemoving =
                            cartCtrl.removingIndex.value == index;
